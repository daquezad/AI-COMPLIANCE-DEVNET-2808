...
const PROVISIONING_CONFIG: GraphConfig = {
  ...
  nodes: [
    ...
    {
      id: NODE_IDS.PROVISIONING_SUPERVISOR,
      type: NODE_TYPES.CUSTOM,
      position: { x: 150, y: 150 },
      parentId: "compliance-group",
      ...
      data: {
        ...
        label2: "Agent",
        handles: HANDLE_TYPES.SOURCE,
        githubLink: "https://github.com/agntcy/agentic-apps",
        isBold: true,
        verificationStatus: VERIFICATION_STATUS.VERIFIED,
        hasBadgeDetails: true,
      },
  ...
  edges: [],
  animationSequence: [
    { ids: [NODE_IDS.PROVISIONING_SUPERVISOR] },
  ],
}
